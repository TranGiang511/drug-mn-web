...
// ENV=prod
$config['licenseName'] = 'daitrangtw28.vn';
$config['licenseKey']  = '1SPSJWAY6RMAK7CKW1JPR5QPNDUGR';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'https://daitrangtw28.vn/uploads/',
    // 'root'         => FCPATH .'http://localhost/rab/public/uploads/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
